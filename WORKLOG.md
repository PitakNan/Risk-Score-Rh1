...
## 2026-09-11 — อัพเดตงวด ส.ค. 2569 (mdb รอบ 2026-09) + PUSH LIVE `cefd072`

**ที่มาข้อมูล:** `HFO/Output/2026-09/_extracted/D_เขต1_2026-09/D5317.mdb` (โหลด 10 ก.ย. 69 เวลา 23:53)

**วิธีทำ:** `python risk_routine.py --month 2026-09 --dry-run` → ตรวจผลแล้วรันจริงไม่ใส่ `--dry-run`
(routine หา mdb เอง → inject → verify → archive `index(2026-09-11).html` → copy เข้า repo)

**ผล:**
- เพิ่มงวด ส.ค. 2569 (sort_key 202608) ครบ **103 รพ.**
- FY2569 = **11 งวด / 1,133 records** (ต.ค.68–ส.ค.69) · รวมทั้งไฟล์ 59 งวด / 6,065 records
- verify ผ่าน: parse RAW ได้ + งวดครบ + label พ.ศ. ถูกทุกงวด
- ยืนยันบน URL จริง (pitaknan.github.io/Risk-Score-Rh1) เห็นงวด "ส.ค. 2569" แล้ว

**การกระจาย Risk Score (103 รพ.):**

| risk | 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 |
|---|---|---|---|---|---|---|---|---|
| ก.ค. 69 | 28 | 18 | 13 | 14 | 7 | 5 | 6 | 12 |
| ส.ค. 69 | 19 | 16 | 12 | 21 | 7 | 4 | 11 | 13 |

⚠️ **แย่ลงชัดเจน** — risk 0 (ปลอดภัย) 28→19 แห่ง · กลุ่มวิกฤต (6-7) 18→**24 แห่ง**
